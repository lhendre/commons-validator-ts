        ...
        export const infrastructureTlds = ["arpa"];

        export const genericTlds = ["aaa", // aaa American Automobile Association, Inc.
            "aarp", // aarp AARP
            "abb", // abb ABB Ltd
...
// WARNING: this array MUST be sorted, otherwise it cannot be searched reliably using binary search
        export const countryCodeTlds = ["ac", // Ascension Island
            "ad", // Andorra
...
//        "tp",                 // East Timor (Retired)
            ...
            "ws", // Samoa (formerly Western Samoa)g
